...
# ==============================================================================
# List of changes:
# - added a progress information
# - changed the input-glob argument to match other MLPerf scripts
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-dir", help="A directory with the input files", required=True, type=str)
    ...
    for filename in os.listdir(args.input_dir):
        ...
        for record in tf.data.TFRecordDataset(os.path.join(args.input_dir,filename)):
                example = tf.train.Example()
