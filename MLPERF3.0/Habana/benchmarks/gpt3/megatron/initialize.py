...
def initialize_megatron(extra_args_provider=None, args_defaults={},
    ...
    args = get_args()
    if args.rank == 0:
        mllog.config(filename=args.mllog_output_path)
    ...
    if args.use_hpu:
        ...
        os.environ["PT_HPU_ENABLE_GENERIC_STREAM"] = "false"
        os.environ["PT_HPU_ENABLE_SCALAR_CACHE_LOCKGUARD"] = "true"
    ...
    if  args.lazy_mpu_init:
        ...
        return finish_mpu_init, mllogger
    else:
