...
def get_args():
    ...
    parser.add_argument("--dataset-file", default="/mnt/weka/data/pytorch/gpt-j/cnn_eval.json", help="path to cnn_eval.json")
...
def main():
    ...
    data_object = Dataset(model_name, dataset_path)
