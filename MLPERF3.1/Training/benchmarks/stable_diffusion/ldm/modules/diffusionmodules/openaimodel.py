...
class UNetModel(nn.Module):
    ...
    def q_sample(self, x_start, t, noise,  **kwargs):
        sqrt_alphas_cumprod = kwargs['sqrt_alphas_cumprod']
        sqrt_one_minus_alphas_cumprod = kwargs['sqrt_one_minus_alphas_cumprod']
        if sqrt_alphas_cumprod is not None and sqrt_one_minus_alphas_cumprod is not None:
    ...
    def forward(self, x, timesteps=None, context=None, y=None,**kwargs):
        ...
        x = self.q_sample(x_start=x, t=timesteps, noise=noise, **kwargs)
