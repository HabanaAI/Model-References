...
from unet_2d_condition_hpu import unet_forward_hpu
...
class StableDiffusionXLPipeline_HPU(StableDiffusionXLPipeline):
    ...
    def __init__(
        ...
        self.unet.forward = unet_forward_hpu

    def run_unet(self, unet, latents, timesteps, do_classifier_free_guidance, t, i, add_text_embeds,
            add_time_ids, prompt_embeds, guidance_scale, guidance_rescale, extra_step_kwargs,
            num_warmup_steps, progress_bar, callback,callback_steps, cross_attention_kwargs):
            ...
            if self.quantized:
                for i, t in enumerate(timesteps[0:-2]):
                    latents = self.run_unet(self.unet, latents, timesteps,
                                            do_classifier_free_guidance ,t ,i ,
                                            add_text_embeds ,add_time_ids ,prompt_embeds,
                                            guidance_scale, guidance_rescale, extra_step_kwargs,
                                            num_warmup_steps, progress_bar, callback,
                                            callback_steps, cross_attention_kwargs)
