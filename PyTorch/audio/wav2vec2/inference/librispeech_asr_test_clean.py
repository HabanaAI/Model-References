...
###############################################################################
"""The original script was from https://huggingface.co/datasets/librispeech_asr/blob/main/librispeech_asr.py.
   This is a reduced version of the original script to reduce data downloading and processing time
   by keeping test clean configuration only. Without this script, it will download the whole clean
   dataset ~60GB including training set and dev set."""
