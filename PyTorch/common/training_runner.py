...
class TrainingRunner(object):
    ...
    def setup_config_env(self):
        ...
        if self.__multi_hls:
            ...
            run_per_ip((f"python3 {str(gen_hcl_path)} {tmp_dir} "
    ...
    def create_single_hls_setup(self):
        ...
        self.setup_config_env()
        self.__interpreter = f"python3 -um torch.distributed.launch --nproc_per_node={self.__world_size} {use_env_param} "
    ...
    def create_multi_hls_setup(self):
        ...
        cmd += "--rank-by core --report-bindings python3 "
