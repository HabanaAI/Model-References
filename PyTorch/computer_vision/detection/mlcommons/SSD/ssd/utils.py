...
class Encoder(object):
    ...
    def __init__(self, dboxes, use_hpu=False, hpu_device=None):
    ...
    def scale_back_batch(self, bboxes_in, scores_in):
        ...
        if bboxes_in.device == torch.device("cpu"):
            ...
            self.dboxes = self.dboxes.to(self.hpu_device)
            self.dboxes_xywh = self.dboxes_xywh.to(self.hpu_device)
        else:
