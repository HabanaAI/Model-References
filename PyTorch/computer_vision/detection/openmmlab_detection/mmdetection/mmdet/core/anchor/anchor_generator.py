...
from mmcv.utils import groundtruth_processing_on_cpu
...
class AnchorGenerator:
    ...
    def single_level_grid_priors(self,
        ...
        if groundtruth_processing_on_cpu(): #to avoid shift_x,shift_y to become bf16 in hmp
        ...
        # then (0, 1), (0, 2), ...
        if groundtruth_processing_on_cpu():#to avoid all_anchors to become bf16 in hmp
            all_anchors = all_anchors.to(dtype)
        return all_anchors
