...
from mmcv.utils import register_hpuinfo
...
def parse_args():
    ...
    parser.add_argument('--groundtruth-processing-on-hpu',
                         action='store_true',
...
def main():
    ...
    register_hpuinfo(hpu_enabled, lazy_enabled, args.autocast, not args.groundtruth_processing_on_hpu)
