...
def all_reduce(py_dict, device="cuda", op="sum", group=None):
    """
    ...
    py_key_tensor = pyobj2tensor(py_key, device)
...
def all_reduce_norm(module, device):
    """
