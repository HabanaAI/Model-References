...
if __name__ == "__main__":
    ...
    trainer = Trainer(
        ...
        checkpoint_callback=ckpt_callback, #  changed in pl1.4
        plugins=DDPPlugin(bucket_cap_mb=args.bucket_cap_mb,gradient_as_bucket_view=True,static_graph=True) if args.hpus > 1 else None,
