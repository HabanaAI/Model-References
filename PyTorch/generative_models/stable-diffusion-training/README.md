...
export PYTHONPATH=$MODEL_REF_PYTORCH_PATH/generative_models/stable-diffusion-training/src/taming-transformers:$PYTHONPATH
```
...
```
python main.py --base hpu_config_web_dataset.yaml --train --scale_lr False --seed 0 --hpus 1 --batch_size 8 --use_lazy_mode True --hmp --no-test True --max_epochs 10 --limit_train_batches 1000 --limit_val_batches 0  --hpu_graph True --ckpt_path="/software/lfs/data/pytorch/stable-diffusion/checkpoint/model.ckpt" --dataset_path="/software/lfs/data/pytorch/stable-diffusion/laion2B-data/"
```
...
|---------|-------------------|-----------------|--------------|------------|
| Gaudi   | 1.9.0             | 1.13.1          | 1.9.4 | Training |
| Gaudi   | 1.7.1             | 1.13.1          | -     | Inference |
| Gaudi2  | 1.9.0             | 1.13.1          | 1.9.4 | Training |
