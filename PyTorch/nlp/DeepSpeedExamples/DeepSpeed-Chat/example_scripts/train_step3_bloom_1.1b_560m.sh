...
#  print_answers_interval - =0: do not print answers, >0: print interval
# -----------------------------------------------------------------------
...
lora_actor_learning_rate=${HL_LORA_ACTOR_LR:-1e-5}
actor_weight_decay=${HL_ACTOR_WD:-0.1}
critic_learning_rate=${HL_CRITIC_LR:-6e-6}
lora_critic_learning_rate=${HL_LORA_CRITIC_LR:-6e-6}
