...
class DeepSpeedRLHFEngine():
    ...
    def _init_actor(self, actor_model_name_or_path):
        ...
        # Model
        actor_dropout = 0. if self.args.disable_actor_dropout else self.args.actor_dropout
    ...
    def _init_critic(self, critic_model_name_or_path):
        ...
        # Model
        # Note that critic model does not calculate reward loss
        critic_dropout = 0. if self.args.disable_critic_dropout else self.args.critic_dropout
    ...
    def _init_reward(self, critic_model_name_or_path):
        ...
        # Model
        # Note that reward model is frozen and does not calculate reward loss
