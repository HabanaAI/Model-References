...
def load_ds_checkpoint_and_setup_megatron(parallel_output):
    ...
    from pretrain_gpt import model_provider as pretrain_gpt_model_provider

    deepspeed.runtime.state_dict_factory.MegatronSDLoader.sanity_check = lambda self, ckpt_file_name: None

    cp_path = args.load
    args.load = None
    model_provider_fn = functools.partial(pretrain_gpt_model_provider, parallel_output=parallel_output)
