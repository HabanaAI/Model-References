...
class CommonConfig(FairseqDataclass):
    ...
    hpu: bool = field(default=False, metadata={"help": "use HPU instead of CUDA"})
    ...
    force_model_parallel_init: bool = field(
        default=False,
        metadata={
            "help": "force model parallel distribution initialization regardless of model_parallel_size"
        }
    )
