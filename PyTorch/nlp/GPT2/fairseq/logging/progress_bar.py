...
def progress_bar(
    ...
    tb_key_suffix: Optional[str] = None,
):
    ...
    if tensorboard_logdir:
        try:
            ...
            bar = TensorboardProgressBarWrapper(bar, tensorboard_logdir, key_suffix=tb_key_suffix)
...
class TensorboardProgressBarWrapper(BaseProgressBar):
    ...
    def __init__(self, wrapped_bar, tensorboard_logdir, key_suffix=None):
        self.wrapped_bar = wrapped_bar
        self.tensorboard_logdir = tensorboard_logdir
        self.key_suffix = '_' + key_suffix if key_suffix is not None else ''
    ...
    def _writer(self, key):
        ...
        if key not in _writers:
            _writers[key] = SummaryWriter(os.path.join(self.tensorboard_logdir, key + self.key_suffix))
