...
def linear_init_method(tensor, gain=1/math.sqrt(2)):
...
class ModelParallelTransformerEncoderLayer(TransformerEncoderLayer):
    ...
    def build_fc1(self, input_dim, output_dim, q_noise, qn_block_size):
        ...
        return ColumnParallelLinear(input_dim, output_dim, gather_output=False, init_method=linear_init_method)

    def build_fc2(self, input_dim, output_dim, q_noise, qn_block_size):
        if q_noise > 0:
            raise NotImplementedError
        return RowParallelLinear(input_dim, output_dim, input_is_parallel=True, init_method=linear_init_method)
