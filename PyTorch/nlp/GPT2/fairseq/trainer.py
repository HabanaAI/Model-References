...
class Trainer(object):
    ...
    def __init__(self, cfg: FairseqConfig, task, model, criterion, quantizer=None):
        ...
        if self.cuda:
            ...
            # TODO: [SW-70315] Remove mark_step when partial compute triggered
            os.environ["PT_HPU_EVALUATE_PERSISTENT_TENS_WITH_MS"]="true"
    ...
    def load_checkpoint(
        ...
        if bexists:
            load_on_all_ranks = (
                ...
                or self.tpu
                # for HPU load ckpt on every worker
                or self.cfg.common.hpu
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        for i, sample in enumerate(samples):  # delayed update loop
            ...
            if self.cfg.common.hpu and i < len(samples) - 1:
                # hpu-comment: every HPU operation before marking step is
                # appended to the IR graph, and processing too many batches
                # before marking step can lead to OOM errors.
                # To handle gradient accumulation use case, we explicitly
                # mark step here for every forward pass without a backward pass
        ...
        try:
            ...
            with torch.autograd.profiler.record_function("optimizer"):
                ...
                if self.cfg.common.hpu and os.environ.get('PT_HPU_LAZY_MODE') == "1":
                    import habana_frameworks.torch.core as htcore
                    htcore.mark_step()
    ...
    def _prepare_sample(self, sample, is_dummy=False):
        ...
        if self.cuda:
            ...
            sample = utils.move_to_hpu(sample,device=self.device)
