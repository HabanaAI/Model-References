...
python3 ${data_dir}/bertPrep.py --action create_hdf5_files --dataset $DATASET --max_seq_length 128 \
...
python3 ${data_dir}/bertPrep.py --action create_hdf5_files --dataset $DATASET --max_seq_length 512 \
