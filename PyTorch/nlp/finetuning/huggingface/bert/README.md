# Table of Contents
- [BERT, RoBERTa and ALBERT for PyTorch](#bert-roberta-and-albert-for-pytorch)
...
# BERT, RoBERTa and ALBERT for PyTorch
...
## Reference Script
The demo uses training scripts and models from https://github.com/huggingface/transformers.git (tag v4.12.3). The training script fine-tunes BERT based language models on the [Microsoft Research Paraphrase Corpus](https://gluebenchmark.com/) (MRPC) and [Stanford Question Answering Dataset](https://rajpurkar.github.io/SQuAD-explorer/) (SQuADv1.1) dataset.
...
```
$PYTHON demo_bert.py finetuning --model_name_or_path albert-large --mode lazy --dataset_name squad --task_name squad --data_type bf16 --num_train_epochs 2 --batch_size 32 --max_seq_length 384 --learning_rate 5e-5 --do_eval --device hpu --per_device_eval_batch_size 4 --world_size 8
```
