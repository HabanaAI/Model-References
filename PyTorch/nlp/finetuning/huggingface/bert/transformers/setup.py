...
4. Checkout the release branch (v<RELEASE>-release, for example v4.20-release), and commit these changes with the
...
setup(
    name="transformers",
    version="4.20.1",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
