...
- The training examples are applicable for fist-gen Gaudi and **Gaudi2**
...
- The docker is installed and set up as per the [Gaudi Setup and Installation Guide](https://github.com/HabanaAI/Setup_and_Install). This ensures the docker has access to all 8 cards required for multi-card demo. 
