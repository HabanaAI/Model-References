    ...
    if cfg.use_habana:
        ...
        if ('WORLD_SIZE' in os.environ and
            ...
            try:
                ...
                cfg.distributed_world_size = mpi_comm.Get_size()
                if cfg.distributed_world_size > 1:
                    cfg.distributed_rank  = mpi_comm.Get_rank()
                    local_rank = cfg.distributed_rank # To be rechecked
                else:
        ...
        if multinode:
            ...
            cfg.distributed_backend="hccl"
            cfg.distributed_init_method = "env://"
            cfg.distributed_no_spawn = True
            torch.distributed._DEFAULT_FIRST_BUCKET_BYTES=cfg.bucket_cap_mb
