...
```
$PYTHON demo_bert.py pretraining --model_name_or_path large --mode lazy --data_type bf16 --batch_size 64 8 --accumulate_gradients --allreduce_post_accumulation --allreduce_post_accumulation_fp16 --data_dir <packed_dataset_path_phase1> <packed_data_path_phase2> --enable_packed_data_mode --avg_seq_per_pack 1.2 2
```
...
```
$PYTHON demo_bert.py pretraining --model_name_or_path large --mode lazy --data_type bf16 --world_size 8 --batch_size 64 8 --accumulate_gradients --allreduce_post_accumulation --allreduce_post_accumulation_fp16 --dist --data_dir <packed_dataset_path_phase1> <packed_data_path_phase2> --enable_packed_data_mode --avg_seq_per_pack 1.2 2
```
...
```python
$PYTHON -u demo_bert.py pretraining --world_size 32 --model_name_or_path large --config_file /root/model_garden/PyTorch/nlp/bert/pretraining/bert_config.json --output_dir /root/nfs/BERT_PRETRAINING/results/checkpoints --seed 42 --allreduce_post_accumulation --allreduce_post_accumulation_fp16 --accumulate_gradients --device hpu --mode lazy --data_type bf16 --data_dir <dataset_path_phase1> <data_path_phase2>  --max_seq_length 128 512 --train_batch_size 65536 32768 --batch_size 64 8 --learning_rate 0.006 0.004 --warmup 0.2843 0.128 --max_steps 7038 1563 --init_checkpoint None None --phase 1 --process_per_node 8
$PYTHON -u demo_bert.py pretraining --world_size 32 --model_name_or_path large --config_file /root/model_garden/PyTorch/nlp/bert/pretraining/bert_config.json --output_dir /root/nfs/BERT_PRETRAINING/results/checkpoints --seed 42 --allreduce_post_accumulation --allreduce_post_accumulation_fp16 --accumulate_gradients --device hpu --mode lazy --data_type bf16 --data_dir <dataset_path_phase1> <data_path_phase2>  --max_seq_length 128 512 --train_batch_size 65536 32768 --batch_size 64 8 --learning_rate 0.006 0.004 --warmup 0.2843 0.128 --max_steps 7038 1563 --init_checkpoint None None --phase 2 --process_per_node 8
```
ii. Using packed data: lazy mode, bf16 mixed precision, per chip BS64 for phase1 and BS8 for phase2:
```python
$PYTHON demo_bert.py pretraining --world_size 32 --model_name_or_path large --enable_packed_data_mode --avg_seq_per_pack 1.2 2 --config_file /root/model_garden/PyTorch/nlp/pretraining/bert/bert_config.json --output_dir /root/nfs/BERT_PRETRAINING/results/checkpoints --seed 42 --allreduce_post_accumulation --allreduce_post_accumulation_fp16 --accumulate_gradients --device hpu --data_type bf16 --data_dir <packed_dataset_path_phase1> <packed_dataset_path_phase2> --max_seq_length 128 512 --train_batch_size 65536 32768 --batch_size 64 8 --learning_rate 0.006 0.004 --warmup 0.2843 0.128 --max_steps 7038 1563 --process_per_node 8  --phase 1
$PYTHON demo_bert.py pretraining --world_size 32 --model_name_or_path large --enable_packed_data_mode --avg_seq_per_pack 1.2 2 --config_file /root/model_garden/PyTorch/nlp/pretraining/bert/bert_config.json --output_dir /root/nfs/BERT_PRETRAINING/results/checkpoints --seed 42 --allreduce_post_accumulation --allreduce_post_accumulation_fp16 --accumulate_gradients --device hpu --data_type bf16 --data_dir <packed_dataset_path_phase1> <packed_dataset_path_phase2> --max_seq_length 128 512 --train_batch_size 65536 32768 --batch_size 64 8 --learning_rate 0.006 0.004 --warmup 0.2843 0.128 --max_steps 7038 1563 --process_per_node 8  --phase 2
```
