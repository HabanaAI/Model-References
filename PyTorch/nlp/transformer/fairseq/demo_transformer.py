...
class TransformerArgparser(argparse.ArgumentParser):
    ...
    def __init__(self, **kwargs):
        ...
        self.add_argument('--save-interval-updates', required=False, type=int, default=1000, help='Save checkpoints after this much updates.')
...
def main():
    ...
    fairseq_path = get_canonical_path_str(script_dir)
