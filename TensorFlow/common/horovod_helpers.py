...
class SynapseLoggerHelpers:
    ...
    def _synapse_logger_required():
        return SynapseLoggerHelpers._get_synapse_logger_env() in ["true", "t", "1", "on", "all", "range", "traceme"]
    ...
    def _synapse_logger_type():
        if SynapseLoggerHelpers._synapse_logger_required():
            ...
            elif SynapseLoggerHelpers._get_synapse_logger_env() in ["traceme"]:
                return SynapseLoggerType.TRACEME
            else:
    ...
    def _setup_synapse_logger(log_name_prefix=""):
        ...
        if log_name_prefix:
            ...
            if SynapseLoggerHelpers._synapse_logger_type() == SynapseLoggerType.TRACEME:
