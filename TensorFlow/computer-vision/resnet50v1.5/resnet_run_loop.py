...
from demo.resnet import imagenet_preprocessing
from demo.resnet import resnet_model
from demo.resnet.utils import export
from demo.resnet.utils.flags import core as flags_core
from demo.resnet.utils.logs import hooks_helper
from demo.resnet.utils.logs import logger
from demo.resnet.utils.misc import distribution_utils
from demo.resnet.utils.misc import model_helpers
from demo.horovod_helpers import hvd, horovod_enabled
from demo.habana_estimator import HabanaEstimator
from demo.str2bool import condition_env_var
from demo.resnet import imagenet_main
import demo.resnet.utils.optimizers.LARSOptimizer as lars
...
def resnet_main(
  ...
  if horovod_enabled():
    ...
    if "tf_profiler_hook" not in flags_obj.hooks and os.environ.get("TF_RANGE_TRACE", False):
      from demo.utils import RangeTFProfilerHook
  ...
  if max_eval_steps is None:
    max_eval_steps = imagenet_main.NUM_IMAGES['validation'] // flags_obj.batch_size
