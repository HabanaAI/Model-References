...
from TensorFlow.common.tb_utils import TensorBoardHook
from TensorFlow.computer_vision.Resnets.ResNeXt.utils.logs import hooks
from TensorFlow.computer_vision.Resnets.ResNeXt.utils.logs import logger
from TensorFlow.computer_vision.Resnets.ResNeXt.utils.logs import metric_hook
...
def get_profiler_hook(model_dir, profile_steps, **kwargs):  # pylint: disable=unused-argument
  """Function to get ProfilerHook.

  Args:
    model_dir: The directory to save the profile traces to.
    profile_steps: `string`, print profile traces of X-Y steps.
  ...
  """
  return TensorBoardHook(model_dir,profile_steps)
