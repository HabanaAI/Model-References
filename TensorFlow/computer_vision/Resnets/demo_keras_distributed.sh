...
function usage()
{
        echo -e "usage: IMAGENET_DIR=<path/to/imagenet/database> demo_keras_distributed.sh\n"
        echo -e "\nexample:\n"
        echo -e "  IMAGENET_DIR=~/tensorflow_datasets/imagenet/tf_records/ ./demo_keras_distributed.sh"
        echo -e ""
}

# Default setting
export TF_ENABLE_BF16_CONVERSION=${TF_ENABLE_BF16_CONVERSION:-1}
#export TF_BF16_CONVERSION=/root/model_garden/TensorFlow/common/bf16_config/full.json
