...
- ResNet50, 1 HPU, batch 256, 40 epochs, bf16 precision, LARS
    ...
    --optimizer LARS --base_learning_rate 9.5 --warmup_epochs 3 --lr_schedule polynomial --label_smoothing 0.1 --weight_decay 0.0001 --single_l2_loss_op
    ```
...
- Added Habana Media Loaded to allow future performance improvement
