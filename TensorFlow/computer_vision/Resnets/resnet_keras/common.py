...
from TensorFlow.common.multinode_helpers import comm_size
...
def define_habana_flags():
    ...
    flags.DEFINE_boolean("use_native_keras_mixed_precision_policy", default=False, help="If set to true, uses native keras mixed precision policy "
