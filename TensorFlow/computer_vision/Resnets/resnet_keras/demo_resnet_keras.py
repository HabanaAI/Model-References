...
def main():
    ...
    if '--help' in unknown_args or '-h' in unknown_args:
        ...
        python demo_resnet_keras.py -dt bf16 -dlit bf16 --experimental_preloading -b 256
        python demo_resnet_keras.py -te 90 --optimizer LARS -b 128
        python3 demo_resnet_keras.py --dtype bf16 -dlit bf16 --use_horovod --num_workers_per_hls 8 -te 40 --optimizer LARS -b 256
