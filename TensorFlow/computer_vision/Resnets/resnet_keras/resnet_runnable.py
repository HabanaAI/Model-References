...
from TensorFlow.computer_vision.Resnets.resnet_keras.official.modeling import grad_utils
from TensorFlow.computer_vision.Resnets.resnet_keras.orbit import standard_runnable
...
class ResnetRunnable(standard_runnable.StandardTrainable,
  ...
  def build_train_dataset(self):
    ...
    return utils.make_distributed_dataset(
        ...
        datasets_num_private_threads=self.flags_obj.datasets_num_private_threads,
  ...
  def train_loop_begin(self):
    ...
    if hvd is not None and hvd.is_initialized() and self.global_step.value() == 0:
