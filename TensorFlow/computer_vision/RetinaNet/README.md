...
## Table of Contents
*  Please visit [this page](../../../README.md) for performance information.
*  [Model overview](#Model-overview)
    *  [Changes to the original model](#Changes-to-the-original-model)
*  [Setup](#Setup)
    *  [Install Drivers](#Install-Drivers)
    *  [Clone the repo](#Clone-the-repo)
    *  [Prepare COCO 2017 Dataset](#Prepare-COCO-2017-Dataset)
        *  [Download COCO 2017 dataset](#Download-COCO-2017-dataset)
        *  [Convert COCO 2017 data to tfrecord](#Convert-COCO-2017-data-to-tfrecord)
    *  [Download the backbone checkpoint](#Download-the-backbone-checkpoint)
*  [Training the Model](#Training-the-model)
*  [Examples](#Examples)
*  [Known Issues](#Known-Issues)

## Model Overview
This Repository implements training RetinaNet on a single HPU.
External source for this code is: https://github.com/tensorflow/models/tree/03944bb4c9138672392f4ac52fd68bc17b5f5792
[1] Tsung-Yi Lin, Priya Goyal, Ross Girshick, Kaiming He, Piotr Dollár Focal Loss for Dense Object Detection. Arxiv link: https://arxiv.org/abs/1708.02002

This model was tested to work with TensorFlow 2.5.0

### Changes to the original model
* Enabled HPU
* Disabled dynamic shapes
* Disabled eager to function rewriter
* Applied workarund for high dimensionality tensor until N-Dims support is available
