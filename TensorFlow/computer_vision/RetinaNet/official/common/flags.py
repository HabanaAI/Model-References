...
###############################################################################
# List of changes:
# - enable selection of bf16 data type
...
def define_flags():
  ...
  flags.DEFINE_enum(
        ...
        enum_values=['bf16', 'fp32'],
        help='Data type: fp32 or bf16. Default is fp32.')

  flags.DEFINE_string(name='bf16_config_path', default='basic',
                      help=f'Path to mixed precision config to use given in JSON format.'
                      ' Ignored if dtype isnt bf16. Default is basic')
