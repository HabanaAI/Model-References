...
def main(_):
  ...
  # This is a temporary hack to mitigate issues related to inconsistencies
  # of implementation of copies of get_distribute_strategy() function.
  if params.runtime.num_hpus == 1:
    distribution_strategy = OneDeviceStrategy("device:HPU:0")
  else:
