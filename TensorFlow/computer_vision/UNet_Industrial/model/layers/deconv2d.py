...
def deconv2d(
    ...
    data_format='NHWC',
    use_bias=True,
    kernel_initializer=tf.compat.v1.initializers.variance_scaling(),  ##tf.variance_scaling_initializer(),
    ...
    with tf.compat.v1.variable_scope("deconv2d"):
        ...
        if use_upscale_conv:
            ...
            layer = tf.compat.v1.layers.conv2d_transpose(
                inputs=inputs,
                filters=n_channels,
                kernel_size=kernel_size,
                strides=(2, 2),
