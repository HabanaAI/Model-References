...
# - add mixed precision bf16 training setup
...
def parse_cmdline():
    ...
    p.add_argument('--num_workers_per_hls', type=int, default=1,
    ...
    p.add_argument("--hls_type", default="HLS1", type=str,
                        help="type of HLS")
    p.add_argument("--kubernetes_run", action='store_true',
    ...
    p.add_argument('--num_iter', type=int, default=2500, required=False, help="""Number of iterations to run.""")

    p.add_argument('--batch_size', type=int, default=16, required=False, help="""Size of each minibatch per GPU.""")
    ...
    p.add_argument('--dtype', '-d', choices=['fp32', 'bf16'],
    ...
    p.add_argument('--bf16_config_path', metavar='<path/to/custom/config.json>',
