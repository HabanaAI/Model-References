...
- single Gaudi card training with batch size 8, bfloat16 precision and fold 0:
    ```bash
    $PYTHON unet2d_demo.py --data_dir /root/dataset --batch_size 8 --dtype bf16 --model_dir /tmp/unet2d_1_hpu --fold 0 --tensorboard_logging
    ```
- single Gaudi card training with batch size 8, float32 precision and fold 0:
    ```bash
    $PYTHON unet2d_demo.py --data_dir /root/dataset --batch_size 8 --dtype fp32 --model_dir /tmp/unet2d_1_hpu --fold 0 --tensorboard_logging
    ```
