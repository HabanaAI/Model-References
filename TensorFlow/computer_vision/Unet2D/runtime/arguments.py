...
#   use_horovod, tensorboard_logging, bf16_config_path, tf_verbosity, hls_type,
...
def get_parser(description, distributed_launcher):
    ...
    parser.add_argument("--hls_type", default="HLS1", type=str,
                        help="Type of HLS" if distributed_launcher else argparse.SUPPRESS)  # ignored by unet2d.py
