...
###############################################################################
# Changes:
# - logic from main.py was moved to main() function
...
def main():
    ...
    if params.tensorboard_logging:
        tb_logger = namedtuple('TBSummaryWriters', 'train_writer eval_writer')(
            tf.summary.create_file_writer(params.log_dir),
            tf.summary.create_file_writer(os.path.join(params.log_dir, 'eval')))
