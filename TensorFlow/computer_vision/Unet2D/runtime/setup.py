...
# - set TF_ENABLE_BF16_CONVERSION flag to unet2d for bfloat16 precision
...
def set_flags(params):
    ...
    if not params.disable_hpu:
        from TensorFlow.common.library_loader import load_habana_module
        load_habana_module()

    if params.dtype == 'bf16':
        os.environ['TF_ENABLE_BF16_CONVERSION'] = "unet2d"
...
def prepare_model_dir(params):
    ...
    model_dir = model_dir if (worker_id == 0 and not params.benchmark) else None
