...
from TensorFlow.common.image_classification.efficientnet import efficientnet_config
from TensorFlow.common.image_classification.resnet import resnet_config
