...
from computer_vision.image_classification.efficientnet import efficientnet_config
from computer_vision.image_classification.resnet import resnet_config
