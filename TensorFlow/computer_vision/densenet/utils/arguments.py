...
class DenseNetArgumentParser(argparse.ArgumentParser):
    def __init__(self, description):
        ...
        self.add_argument('--dataset_num_parallel_calls', type=int, default=tf.data.experimental.AUTOTUNE,
                          help='Determines the number of parallel calls in dataset operations')
