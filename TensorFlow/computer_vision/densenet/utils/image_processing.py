...
###############################################################################
# List of changes:
# - Removed random color distortion from training data preprocessing
# - Removed random image rotation from training data preprocessing
# - Removed adding summaries
...
def distorted_bounding_box_crop(image_buffer,
  ...
  """
  with tf.compat.v1.name_scope(scope, 'distorted_bounding_box_crop', [image_buffer, bbox]):
...
def preprocess_for_train(image_buffer,
  ...
  """
  with tf.compat.v1.name_scope(scope, 'distort_image', [image_buffer, height, width, bbox]):
    # random cropping
