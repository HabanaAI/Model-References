...
import utils
from horovod_estimator import HorovodEstimator, hvd_try_init, hvd_info_rank0, hvd, horovod_enabled, is_rank0
...
dataset_default_dirs = ['/data/tensorflow_datasets/coco2017/tfrecord_tf1',
                        '/software/data/coco2017/tf_records',
                        '/software/lfs/data/tensorflow/coco2017/tf_records']
