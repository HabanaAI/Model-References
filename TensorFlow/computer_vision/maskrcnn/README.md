...
| `TF_BF16_CONVERSION=full $PYTHON mask_rcnn_main.py --mode=train --training_file_pattern="/data/tensorflow/coco2017/tf_records/train-*.tfrecord" --validation_file_pattern="/data/tensorflow/coco2017/tf_records/val-*.tfrecord" --val_json_file="/data/tensorflow/coco2017/tf_records/annotations/instances_val2017.json" --train_batch_size 12 --learning_rate_steps=80000,106667 --total_steps=120000 --init_learning_rate=0.015` | Single-card training in bf16 with increased batch size |
...
| `TF_BF16_CONVERSION=full $PYTHON mask_rcnn_main.py --mode=eval --validation_file_pattern="/data/tensorflow/coco2017/tf_records/val-*.tfrecord" --val_json_file="/data/tensorflow/coco2017/tf_records/annotations/instances_val2017.json" --eval_batch_size=12` | Single-card evaluation in bf16 with increased batch size |
| `export TF_BF16_CONVERSION=full; mpirun --allow-run-as-root --bind-to core --map-by socket:PE=7 --np 8 -x TF_BF16_CONVERSION $PYTHON mask_rcnn_main.py --mode=train --training_file_pattern="/data/tensorflow/coco2017/tf_records/train-*.tfrecord" --validation_file_pattern="/data/tensorflow/coco2017/tf_records/val-*.tfrecord" --val_json_file="/data/tensorflow/coco2017/tf_records/annotations/instances_val2017.json" --init_learning_rate=0.04 --learning_rate_steps=30000,40000 --total_steps=45000`| 8-cards training in bf16 |
| `export TF_BF16_CONVERSION=full; mpirun --allow-run-as-root --bind-to core --map-by socket:PE=7 --np 8 -x TF_BF16_CONVERSION $PYTHON mask_rcnn_main.py --mode=train --training_file_pattern="/data/tensorflow/coco2017/tf_records/train-*.tfrecord" --validation_file_pattern="/data/tensorflow/coco2017/tf_records/val-*.tfrecord" --val_json_file="/data/tensorflow/coco2017/tf_records/annotations/instances_val2017.json" --init_learning_rate=0.12 --train_batch_size=12 --eval_batch_size=12 --learning_rate_steps=10000,13334 --total_steps=15000`| 8-cards training in bf16 with increased batch size |
| `export TF_BF16_CONVERSION=0; mpirun --allow-run-as-root --bind-to core --map-by socket:PE=7 --np 8 -x TF_BF16_CONVERSION $PYTHON mask_rcnn_main.py --mode=train --training_file_pattern="/data/tensorflow/coco2017/tf_records/train-*.tfrecord" --validation_file_pattern="/data/tensorflow/coco2017/tf_records/val-*.tfrecord" --val_json_file="/data/tensorflow/coco2017/tf_records/annotations/instances_val2017.json" --init_learning_rate=0.04 --learning_rate_steps=30000,40000 --total_steps=45000` | 8-cards training in fp32 |
...
| `export TF_BF16_CONVERSION=full; mpirun --allow-run-as-root --bind-to core --map-by socket:PE=7 --np 8 -x TF_BF16_CONVERSION $PYTHON mask_rcnn_main.py --mode=eval --validation_file_pattern="/data/tensorflow/coco2017/tf_records/val-*.tfrecord" --val_json_file="/data/tensorflow/coco2017/tf_records/annotations/instances_val2017.json" --eval_batch_size=12` | 8-cards evaluation in bf16 with increased batch size |
...
- added note about Gaudi2 to README
