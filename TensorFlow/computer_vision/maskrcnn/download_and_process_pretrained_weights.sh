...
python3 inspect_checkpoint.py --file_name=mask-rcnn/1555659850/ckpt/model.ckpt \
    > mask-rcnn/1555659850/tensors_and_shape.txt

python3 inspect_checkpoint.py --file_name=resnet/resnet-nhwc-2018-02-07/model.ckpt-112603 \
...
python3 inspect_checkpoint.py --file_name=resnet/extracted_from_maskrcnn/resnet50.ckpt \
