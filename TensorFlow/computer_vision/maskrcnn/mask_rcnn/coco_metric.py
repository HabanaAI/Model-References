...
class EvaluationMetric(object):
  ...
  def __init__(self, filename, include_mask):
    ...
    self.metric_names = [f'eval/{x}' for x in self.metric_names]
  ...
  def predict_metric_fn(self,
    ...
    report_metric = 'eval/mask_AP' if self._include_mask else 'eval/AP'
    metrics_dict['accuracy'] = metrics_dict[report_metric]  # for kibana
    return metrics_dict
