...
def define_hparams_flags():
    ...
    flags.DEFINE_string('pyramid_roi_impl', default='gather', help='Implementation to use for PyramidRoiAlign: [habana | habana_bf16 | gather]')
    ...
    flags.DEFINE_bool(
        'nms_multiclass_workaround',
        default=False,
        help='Enable Multiclass NMS Workaround on HPU'
    )
