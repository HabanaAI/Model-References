  ...
  with tf.name_scope('multilevel_crop_and_resize'):
      if 'habana' in custom_roi:
          ...
          with tf.name_scope('KEEP_FP32_PRECISION'):
              ...
              roi_level = tf.math.floordiv(tf.math.log(tf.divide(areas_sqrt, 224.0)), tf.math.log(2.0)) + 4.0
              roi_level = tf.cast(roi_level, dtype=tf.int32)
              ...
              sampling_ratio=1
          with tf.name_scope('KEEP_FP32_PRECISION') if 'fp32' in custom_roi else suppress():
