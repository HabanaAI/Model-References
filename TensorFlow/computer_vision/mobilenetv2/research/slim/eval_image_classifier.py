...
#   model_name, preprocessing_name, dataset_split_name,  batch_size, max_num_batches,
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    eval_writer = tensorflow.summary.create_file_writer(FLAGS.eval_dir)
