...
"""Run masked LM/next sentence masked_lm pre-training for BERT.
   This file is NOT used to run demo_bert."""
...
import sys
import time
import demo.bert.pretraining.modeling as modeling
import demo.bert.pretraining.optimization as optimization
import tensorflow as tf
import glob
from demo.bert.pretraining.utils.utils import LogEvalRunHook
import demo.bert.pretraining.utils.dllogger_class
from dllogger import Verbosity

from tensorflow.core.protobuf import rewriter_config_pb2

from demo.horovod_helpers import hvd, hvd_init, hvd_size, hvd_rank, horovod_enabled
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      train_op = optimization.create_optimizer(
          total_loss, learning_rate, num_train_steps, num_warmup_steps, optimizer_type=optimizer_type)
