...
import six
import demo.bert.habana_hooks as habana_hooks
import demo.bert.tokenization as tokenization
import demo.bert.optimization as optimization
import demo.bert.modeling as modeling
import random
import math
import json
import collections
...
def main(_):
  ...
  if FLAGS.do_train:
    ...
    train_writer = FeatureWriter(
        filename=per_worker_filenames[worker_id],
        is_training=True)
