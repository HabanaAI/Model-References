...
tf_train_ds = dataset.create_dataset(train_ds, batch_size=params.batch_size)
...
if params.save_summary_steps > 0:
    callbacks.append(TensorBoardWithHParamsV2(
        ...
        update_freq=params.save_summary_steps, write_graph=False))
...
with dump_callback(params.dump_config):
    model.fit(tf_train_ds, epochs=params.epochs, steps_per_epoch=steps,
              callbacks=callbacks, validation_data=tf_valid_ds,
