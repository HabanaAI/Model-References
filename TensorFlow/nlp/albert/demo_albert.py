...
class Albert(object):
  ...
  def finetuning(self, args):
    ...
    if args.test_set == "mrpc":
      ...
      mrpc_runner = albert_mrpc_main.AlbertFinetuningMRPC(hw_config_use_horovod, hw_config_num_workers_per_hls, args.hls_type, args.kubernetes_run,
      ...
      squad_runner = albert_squad_main.AlbertFinetuningSQUAD(hw_config_use_horovod, hw_config_num_workers_per_hls, args.hls_type, args.kubernetes_run,
