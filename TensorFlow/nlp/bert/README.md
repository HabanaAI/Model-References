...
2. Configure password-less ssh between all server (inside all dockers). For AWS users, ensure that the IP addresses of the server are in the same security group and that all traffic is allowed between them. See https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/authorizing-access-to-an-instance.html for details:
