...
## Table of Contents
   ...
   * [Training TensorFlow BERT](#training-tensorflow-bert)
   * [Training BERT in non-Kubernetes environments](#training-bert-in-non-kubernetes-environments)
      ...
      * [Multi-server Horovod-based scale-out distributed training](#multi-hls-horovod-based-scale-out-distributed-training)
         ...
         * [Run BERT training with 32 cards](#run-bert-training-with-32-cards)
         * [Run BERT training with 16 cards](#run-bert-training-with-16-cards)
   * [Training BERT in Kubernetes environments](#training-bert-in-kubernetes-environments)
...
- Single card pretraining Phase 2 of BERT Large in bfloat16 precision using BooksWiki dataset. Initial checkpoint is from Phase 1:
...
-  8 Gaudi cards pretraining Phase 2 of BERT Large in bfloat16 precision using BooksWiki dataset. Initial checkpoint is from Phase 1:
...
Commands for training TensorFlow BERT in K8S environment on single Gaudi card are same as in non-K8S environment.
