...
- Pre-trained model and dataset for MRPC will be automatically downloaded the first time the model is run in the docker container.
  For SQuAD dataset, you need to manually download them to `Model-References/TensorFlow/nlp/bert` folder.
