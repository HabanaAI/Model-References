...
import six
import TensorFlow.nlp.bert.habana_hooks as habana_hooks
import TensorFlow.nlp.bert.tokenization as tokenization
...
if __name__ == "__main__":
  ...
  v1 = os.environ.get('NUM_WORKERS_PER_HLS')
  v2 = os.environ.get('HABANA_INITIAL_WORKSPACE_SIZE_MB')
  v3 = os.environ.get('TF_ENABLE_BF16_CONVERSION')
  print(f"{host_name}: MULTI_HLS_IPS = {vmulti}")
  print(f"{host_name}: HCL_CONFIG_PATH = {vhcl}")
  print(f"{host_name}: NUM_WORKERS_PER_HLS = {v1}")
  print(f"{host_name}: HABANA_INITIAL_WORKSPACE_SIZE_MB = {v2}")
  print(f"{host_name}: TF_ENABLE_BF16_CONVERSION = {v3}")
  sys.stdout.flush()
  sys.stderr.flush()
