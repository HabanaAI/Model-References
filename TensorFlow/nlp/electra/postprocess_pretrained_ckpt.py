...
if __name__ == '__main__':
    ...
    parser.add_argument('--hmp', action='store_true', default=False)
    args = parser.parse_args()
    log("Running postprocess from checkpoint {} , output dir {}".format(args.pretrained_checkpoint, args.output_dir))
