...
def get_args():
    ...
    parser.add_argument('--train_steps', '-ts', type=int,
                        default=300000, help='Number of training steps in total')
    ...
    parser.add_argument('--output_dir', '-od', type=str,
                        help='Output dir', default=argparse.SUPPRESS)
...
def get_training_cmd(script_dir, args):
    ...
    params = [f'python3 {launcher}',
              ...
              get_flag_str('deterministic_dataset', True if args.random_seed is not None else None),
