...
# Changes:
# - updated imports
# - set default model to transformer
# - set default train_steps to 300k
# - set default eval_throttle_seconds to 1
...
flags.DEFINE_integer("train_steps", 300000,
...
flags.DEFINE_integer("local_eval_frequency", 1000,
                     ...
                     "local training.")
flags.DEFINE_integer("eval_throttle_seconds", 1,
