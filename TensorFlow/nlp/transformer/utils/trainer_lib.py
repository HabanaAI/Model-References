...
# Changes:
# - updated imports
# - removed tpu related functionality
# - set default save_summary_steps to 100
# - changed contrib.distribute to tf.distribute
# - removed support for mlperf
# - removed support for mtf_mode
# - added support for horovod
# - removed exporter
# - added ExamplesPerSecondEstimatorHook
# - added ProfilerHook
...
from TensorFlow.nlp.transformer.utils import devices
from TensorFlow.nlp.transformer.utils import hparams_lib
from TensorFlow.nlp.transformer.utils import metrics_hook
from TensorFlow.nlp.transformer.utils import profile
...
def create_experiment(
  ...
  train_hooks += [ExamplesPerSecondEstimatorHook(
  ...
  if hparams.profile_steps is not None:
    train_hooks += [profile.ProfilerHook(hparams.profile_steps, run_config.model_dir)]
