...
###############################################################################
# Changes:
# - replaced 'cpu' argument with 'device' to add support for more devices: cpu/gpu/hpu
# - replaced 'amp' argument with 'dtype' to add support for bfloat16 mixed precision conversion
# - added use_horovod, log_every arguments
...
def parse_args():
    ...
    training_params.add_argument('--device', type=str, choices=['cpu', 'gpu', 'hpu'], default='hpu',
                                 help='Device to be used for computations.')

    training_params.add_argument('--dtype', type=str, choices=['fp32', 'fp16', 'bf16'], default='bf16',
                                 help='Data type to be used during model execution. '
                                      'Note that float16 data type is supported only on GPU.')

    training_params.add_argument('--use_horovod', default=False, action='store_true',
    ...
    run_params.add_argument('--log_every', type=int, default=100,
