...
def get_tensorflow_script_path(model: str) -> Path:
    ...
    model_to_path = {
        ...
        "efficientdet": main_fw_dir / "computer_vision" / "efficientdet" / "demo_efficientdet.py",
        ...
        "pacman_segnet": main_fw_dir / ".." / "internal" / "TensorFlow" / "computer_vision" / "pacman_segnet" / "segnet_training_script.py",
        "vgg_segnet": main_fw_dir / ".." / "TensorFlow" / "computer_vision" / "Segnet" / "keras_segmentation" / "__main__.py"
    }
