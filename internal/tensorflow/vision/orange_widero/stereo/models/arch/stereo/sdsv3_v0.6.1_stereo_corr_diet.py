...
def arch(I_cntr, I_srnd_0, I_srnd_1, I_srnd_2, T_cntr_srnd, focal, origin, steps,
         min_Z=None, max_Z=None, batch_norm=False, batch_renorm=False, training=False, bn_first=True,
         regularization=None):
    ...
    mono_features_l2, to_skip_l0, to_skip_l1 = MonoFeaturesLayer(name='mono_features_l2', batch_norm=batch_norm, batch_renorm=batch_renorm,
                                                                 training=training, bn_first=bn_first,
                                                                 regularizer=regularization)(I_cntr)
    corr_features_func = CorrFeaturesLayer(name='corr_features', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
                                           bn_first=bn_first, regularizer=regularization, activation_and_bn_output=False)
    ...
    unet_dn_l3, to_skip_l2 = DownConvLayer(kernel_size=3, ch_out=96,  name='unet_dn_l3', batch_norm=batch_norm, batch_renorm=batch_renorm,
                                           training=training, bn_first=bn_first, regularizer=regularization)(concat_l2)
    unet_dn_l4, to_skip_l3 = DownConvLayer(kernel_size=3, ch_out=192, name='unet_dn_l4', batch_norm=batch_norm, batch_renorm=batch_renorm,
                                           training=training, bn_first=bn_first, regularizer=regularization)(unet_dn_l3)
    unet_dn_l5, to_skip_l4 = DownConvLayer(kernel_size=3, ch_out=384, name='unet_dn_l5', batch_norm=batch_norm, batch_renorm=batch_renorm,
                                           training=training, bn_first=bn_first, regularizer=regularization)(unet_dn_l4)
    unet_dn_l6, to_skip_l5 = DownConvLayer(kernel_size=3, ch_out=384, name='unet_dn_l6', batch_norm=batch_norm, batch_renorm=batch_renorm,
                                           training=training, bn_first=bn_first, regularizer=regularization)(unet_dn_l5)

    unet_up_l5 = UpConvLayer(ch_out=192, name='unet_up_l5', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
                             bn_first=bn_first, regularizer=regularization)([unet_dn_l6, to_skip_l5])
    unet_up_l4 = UpConvLayer(ch_out=96,  name='unet_up_l4', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
                             bn_first=bn_first, regularizer=regularization)([unet_up_l5, to_skip_l4])
    unet_up_l3 = UpConvLayer(ch_out=48,  name='unet_up_l3', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
                             bn_first=bn_first, regularizer=regularization)([unet_up_l4, to_skip_l3])
    unet_up_l2 = UpConvLayer(ch_out=24,  name='unet_up_l2', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
                             bn_first=bn_first, regularizer=regularization)([unet_up_l3, to_skip_l2])
    unet_up_l1 = UpConvLayer(ch_out=12,  name='unet_up_l1', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
                             bn_first=bn_first, regularizer=regularization)([unet_up_l2, to_skip_l1])
    unet_up_l0 = UpConvLayer(ch_out=1,   name='unet_up_l0', batch_norm=batch_norm, batch_renorm=batch_renorm, training=training,
