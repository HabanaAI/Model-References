...
def arch(I_cntr, I_srnd_0, I_srnd_1, I_srnd_2, T_cntr_srnd, focal_l2, origin_l2,
         ...
         regularization=None, reg_constant=0.01, corr_steps_kwargs=None):
    ...
    unet_dn_l3, to_skip_l2 = DownConvLayer(kernel_size=3, ch_out=64,  name='unet_dn_l3', batch_norm=batch_norm,
                                           training=training, bn_first=bn_first, regularizer=regularizer)(concat_l2)
    unet_dn_l4, to_skip_l3 = DownConvLayer(kernel_size=3, ch_out=96, name='unet_dn_l4', batch_norm=batch_norm,
                                           training=training, bn_first=bn_first, regularizer=regularizer)(unet_dn_l3)
    unet_dn_l5, to_skip_l4 = DownConvLayer(kernel_size=3, ch_out=144, name='unet_dn_l5', batch_norm=batch_norm,
                                           training=training, bn_first=bn_first, regularizer=regularizer)(unet_dn_l4)
    unet_dn_l6, to_skip_l5 = DownConvLayer(kernel_size=3, ch_out=216, name='unet_dn_l6', batch_norm=batch_norm,
                                           training=training, bn_first=bn_first, regularizer=regularizer)(unet_dn_l5)
    unet_up_l5 = UpConvLayer(ch_out=144, name='unet_up_l5', batch_norm=batch_norm, training=training,
    ...
    # confidence
    conf_up_l1 = UpConvLayer(ch_out=16, name='conf_up_l1', batch_norm=batch_norm, training=training,
                             bn_first=bn_first, regularizer=regularizer)([unet_up_l2, to_skip_l1])
    conf_up_l0 = UpConvLayer(ch_out=8, name='conf_up_l0', batch_norm=False, training=training,
