...
class MonoFeaturesLayer(KerasLikeLayer):
    def __init__(self, name='mono_features', regularizer=None, **kwargs):
        ...
        self.mono_l1 = DownConvLayer(ch_out=16, activation='relu', name='mono_l1', regularizer=regularizer)
        self.mono_l2 = DownConvLayer(ch_out=32, activation='relu', name='mono_l2', regularizer=regularizer)
...
class CorrFeaturesLayer(KerasLikeLayer):
    def __init__(self, name='corr_features', regularizer=None, input_shape=None, **kwargs):
        ...
        self.corr_dcl1 = DownConvLayer(ch_out=16, activation='relu', name='corr_l1', regularizer=regularizer)
        self.corr_dcl2 = DownConvLayer(ch_out=32, activation='relu', name='corr_l2', regularizer=regularizer)
        self.corr_dcl3 = DownConvLayer(ch_out=64, activation='relu', name='corr_l3', regularizer=regularizer)
        self.corr_dcl4 = DownConvLayer(ch_out=128, activation='relu', name='corr_l4', regularizer=regularizer)
        self.corr_ucl1 = UpConvLayer(ch_out=256, activation='relu', name='corr_l3_up', regularizer=regularizer,
                                     input_shape=(input_shape[0], input_shape[1] // 16, input_shape[2] // 16, input_shape[3]))
        self.corr_ucl2 = UpConvLayer(ch_out=512, activation='relu', name='corr_l2_up', regularizer=regularizer,
