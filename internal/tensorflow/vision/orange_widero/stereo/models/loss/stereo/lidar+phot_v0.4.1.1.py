...
from stereo.models.loss_utils import loss_image, loss_lidar, min_photo_loss
from stereo.interfaces.implements import implements_format


loss_format = ("loss", "inp_views")
@implements_format(*loss_format)
def loss(out, inp, T_cntr_srnd, focal, origin, im_lidar, im_mask, x, y,
         measure='ssim', radius=1, alpha_ooi=0.0, alpha_lidar=1.0, reg_constant=1.0,  blur_kernel_names=None):
    ...
    batch_loss = tf.identity(loss_phot_ + loss_lidar_ * alpha_lidar, name="batch_loss")
