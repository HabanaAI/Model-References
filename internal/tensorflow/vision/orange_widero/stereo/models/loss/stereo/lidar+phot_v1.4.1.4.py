...
loss_format = ("loss", "three_views_inv")
@implements_format(*loss_format)
def loss(out, I_cntr, I_srnd_0, I_srnd_1, T_cntr_srnd, focal, origin, im_lidar_inv, im_mask, x, y, blur_kernels,
         measure='ssim', radius=1, alpha_ooi=0.0, alpha_lidar=1.0, reg_constant=1.0):
