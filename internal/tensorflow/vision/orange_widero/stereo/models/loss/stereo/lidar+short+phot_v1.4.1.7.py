...
def loss(out, I_cntr, I_srnd_0, I_srnd_1, I_srnd_2, T_cntr_srnd, focal, origin, im_lidar_inv, im_lidar_short_inv, im_mask, photo_loss_im_mask, x, y, blur_kernels,
         measure='ssim', radius=1, alpha_ooi=0.0, alpha_lidar=1.0, alpha_lidar_short=1.0, reg_constant=1.0, lidar_loss_norm=None, lidar_short_loss_norm=None,
    ...
    loss_lidar_short_ = loss_lidar(out, None, tf.zeros_like(im_mask), inv_lidar=im_lidar_short_inv, norm=lidar_short_loss_norm)
