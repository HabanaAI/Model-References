...
def loss(out, curr_inp, prev_inp, next_inp, prev_curr2frame, next_curr2frame, curr_T_cntr_srnd,
    ...
    with tf.compat.v1.name_scope("Loss_"):
        ...
        loss_object, object_loss_Z, direct_loss, sum_direct = advanced_object_consistency_loss(motion_masked_no_y,
                                                                                          curr_instance_mask,
                                                                                          curr_instance_ids,
                                                                                          curr_seg_im,
                                                                                          curr_vcl)
        ...
        loss_ = 10.*direct_loss + static_motion_loss / 10. + loss_motion_
        ...
        _ = tf.reverse(sum_direct, axis=[1], name='sum_direct')
        ...
        _ = tf.identity(direct_loss, name='direct_loss')
