...
import string
import sys
from staging.TensorFlow.nlp.albert import fine_tuning_utils
from staging.TensorFlow.nlp.albert import modeling
from staging.TensorFlow.nlp.albert import optimization
from staging.TensorFlow.nlp.albert import tokenization
import numpy as np
import six
  ...
  with tf.variable_scope("end_logits"):
    if is_training:
      ...
      end_logits = tf.layers.dense(
          ...
          activation=tf.tanh,
          name="dense_0")
      end_logits = tf.keras.layers.LayerNormalization(axis=-1, dtype=tf.float32)(end_logits) 
